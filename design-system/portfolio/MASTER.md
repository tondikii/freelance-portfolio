...
16. (Revisi T48b/c) Form kontak dihapus atas permintaan user — cukup tombol email direct: "Kirim Email" (contact) & icon email (hero) membuka **Gmail compose** ke `tondikiag30@gmail.com` (`https://mail.google.com/mail/?view=cm&to=...`), tanpa `mailto:`. Footer: teks "Dibangun dengan Next.js" dihapus → hanya `© {year} {name}.`.
17. (Stack T49) Tech stack dipangkas drastis untuk audience bisnis: `skillGroups` 40 → 17 chip relevan dgn layanan yang dijual (landing/toko/booking/mobile MVP). Frontend: React, Next.js, Tailwind CSS, React Native, Flutter. Backend: Node.js, Express.js, PostgreSQL, MongoDB. Deploy: Docker, Vercel, Firebase, Git. Bahasa: JavaScript, TypeScript, HTML5, CSS3. Grup Testing & lib UI berlebih (Vue/Nuxt/Bootstrap/MUI/AntD/Vuetify/Spring Boot/Gin/Redis/WebSockets/Heroku/Supabase/Railway/CI/CD/Jest/Playwright/Maestro/Java/Kotlin/Go/Dart) dibuang. Timeline Hyperscal dirapikan ke outcome ("Otomasi testing — QA turun 60%") tanpa menyebut tool.
