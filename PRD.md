...
- CTA primer: "Lihat Demo" (scroll ke #demo). CTA sekunder: "Konsultasi via WhatsApp".
...
- Highlight pengalaman (dari CV, ringkas & disederhanakan untuk awam):
  ...
  - Platform Pembiayaan web/mobile di perusahaan multifinance — 5.000+ pengguna.
...
- **Pengalaman (kurasi):**
  ...
  - Front-end Developer — PT Adira Dinamika Multi Finance Tbk (Mar–Jun 2025): Platform Pembiayaan web/mobile 5k+ pengguna; refactor modul Motorcycle Credit; native Call Management System; mentoring junior.
